...
HD_PWD='D:/250319_Memory/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_ip.tcl
